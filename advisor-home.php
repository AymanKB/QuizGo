            ...
            <?php foreach ($manage_quizes as $quiz) { ?>
              ...
              <div class="media text-muted pt-3">
                ...
                <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                  <strong class="text-gray-dark"><?php echo $quiz[1]; ?></strong>
                  <a href="advisor-student-result.php?id=<?php echo $currentUser[0];?>&quizId=<?php echo $quiz[0] ?>"><strong class=" text-gray-dark float-right">Results</strong></a>
                  <br>
                  <?php echo $quiz[2]; ?>
                </p>
              </div>
              ...
              <div class="mx-5 mt-1 p-3 bg-light rounded ">
                ...
                for($i = 0; $i< count($tempComments); $i++) {
                  if($tempComments[$i][2] == $quiz[0]){
                    // $tempArray = getUserName($tempComments[$i][3]);
                    // $temp = $tempArray['firstName'];
                    ?>
